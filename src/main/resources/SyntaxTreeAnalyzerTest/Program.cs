    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                ...
                XmlWriter writer = XmlWriter.Create("syntax_structure.xml", settings);
                ...
                //clean up XML file
                string text = File.ReadAllText("syntax_structure.xml");
                text = text.Replace("&#xD;", "");
                text = text.Replace("&#xA;", "");
                File.WriteAllText("syntax_structure.xml", text);

                Console.WriteLine("Created the structure file syntax_structure.xml.");
                return;
            }
